      ...
      <Show when={result.error}>
        <Card>
          <CardContent class="pt-8 pb-8 space-y-4">
            ...
            <h1 class="text-2xl font-bold">{t('app.withdrawal_failed')}</h1>
      ...
      <Show when={result()}>
        {(r) => (
          <Card>
            <CardContent class="pt-8 pb-8 space-y-4">
              <div class="text-5xl">👋</div>
              <h1 class="text-2xl font-bold">{t('app.signature_withdrawn')}</h1>
              <p class="text-muted-foreground">
                {t('app.your_signature_for')} <strong>{r().petitionTitle}</strong> {t('app.has_been_removed')}
              </p>
